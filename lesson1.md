...
2. [Данные в современном мире](#Данные_в_современном_мире)
3. [Реляционные базы данных](#Реляционные базы данных)
4. [Подходы к хранению и использованию данных](#Подходы к хранению и использованию данных)
5. [Начинаем работать с данными](#Начинаем работать с данными)
6. [База данных учеников](#База данных учеников)
7. [Предварительный вариант структуры](Предварительный вариант структуры)
8. [Рассмотрим проблемные места предварительной реализации](#Рассмотрим проблемные места предварительной реализации)
9. [Составные значения в ячейках](#Составные значения в ячейках)
...
##[Данные в современном мире](#Данные_в_современном_мире)
